...
local uToggleTerm = plugins.toggleterm
...
-- vim.keymap.set({ "n", "t" }, uToggleTerm.toggle_window_G, M.toggleG)
vim.keymap.set("n", "<leader>ta", M.toggleA)
vim.keymap.set("n", "<leader>tb", M.toggleB)
vim.keymap.set("n", "<leader>tc", M.toggleC)
vim.keymap.set("n", "<leader>tg", M.toggleG)
